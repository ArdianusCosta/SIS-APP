...
<div class="container">
  ...
  <div class="row g-4 justify-content-center">
    ...
    <div class="col-md-3 col-sm-6">
      <a href="{{route('kelab-create')}}" class="info-card">
        <div class="info-icon text-purple"><i class="fas fa-vials"></i></div>
        <div class="info-title">Surat Izin <span class="text-purple">Ke Lab</span></div>
        <div class="info-number">{{$suratTodayCountLab}} Anak</div>
      </a>
    </div>

  </div>

  <!-- Modal Surat Izin Sakit -->
