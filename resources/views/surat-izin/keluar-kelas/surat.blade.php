...
<div class="button-bar fixed top-0 left-0 w-full bg-white shadow-md z-50">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div class="text-gray-800 font-semibold text-lg">
            Total Surat Keluar Kelas yang Dibuat Hari Ini: {{ $surat->count() }}
        </div>
...
<a href="{{ route('keluar-kelas.surat', ['id' => $suratTerlama->id]) }}"
...
<a href="{{ route('keluar-kelas.surat', ['id' => $suratTerbaru->id]) }}"
